function Home(){
	return(
		<><header>
					...
					<div className="row">
						<div className="col-lg-3 col-md-6 col-sm-6 d-flex">
							<div className="card w-100 my-2 shadow-2-strong">
								<img src="https://mdbootstrap.com/img/bootstrap-ecommerce/items/1.webp" className="card-img-top" />
						...
						<div className="col-lg-3 col-md-6 col-sm-6 d-flex">
							<div className="card w-100 my-2 shadow-2-strong">
								<img src="https://mdbootstrap.com/img/bootstrap-ecommerce/items/2.webp" className="card-img-top"  />
								<div className="card-body d-flex flex-column">
						...
						<div className="col-lg-3 col-md-6 col-sm-6 d-flex">
							<div className="card w-100 my-2 shadow-2-strong">
								<img src="https://mdbootstrap.com/img/bootstrap-ecommerce/items/3.webp" className="card-img-top"  />
								<div className="card-body d-flex flex-column">
						...
						<div className="col-lg-3 col-md-6 col-sm-6 d-flex">
							<div className="card w-100 my-2 shadow-2-strong">
								<img src="https://mdbootstrap.com/img/bootstrap-ecommerce/items/4.webp" className="card-img-top"  />
								<div className="card-body d-flex flex-column">
						...
						<div className="col-lg-3 col-md-6 col-sm-6 d-flex">
							<div className="card w-100 my-2 shadow-2-strong">
								<img src="https://mdbootstrap.com/img/bootstrap-ecommerce/items/5.webp" className="card-img-top"  />
								<div className="card-body d-flex flex-column">
						...
						<div className="col-lg-3 col-md-6 col-sm-6 d-flex">
							<div className="card w-100 my-2 shadow-2-strong">
								<img src="https://mdbootstrap.com/img/bootstrap-ecommerce/items/6.webp" className="card-img-top"  />
								<div className="card-body d-flex flex-column">
						...
						<div className="col-lg-3 col-md-6 col-sm-6 d-flex">
							<div className="card w-100 my-2 shadow-2-strong">
								<img src="https://mdbootstrap.com/img/bootstrap-ecommerce/items/7.webp" className="card-img-top"  />
								<div className="card-body d-flex flex-column">
						...
						<div className="col-lg-3 col-md-6 col-sm-6 d-flex">
							<div className="card w-100 my-2 shadow-2-strong">
								<img src="https://mdbootstrap.com/img/bootstrap-ecommerce/items/8.webp" className="card-img-top"  />
								<div className="card-body d-flex flex-column">
									<h5 className="card-title">T-shirts with multiple colors, for men and lady</h5>
									<p className="card-text">$120.00</p>
									<div className="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
			...
			</section><section className="mt-5 mb-4">
				<div className="container text-dark">
					...
					<div className="row">
						<div className="col-lg-3 col-md-6 col-sm-6 col-12">
							<article>
								<a href="#" className="img-fluid">
									<img className="rounded w-100" src="https://mdbootstrap.com/img/bootstrap-ecommerce/posts/1.webp"  height="160" />
								</a>
						...
						<div className="col-lg-3 col-md-6 col-sm-6 col-12">
							<article>
								<a href="#" className="img-fluid">
									<img className="rounded w-100" src="https://mdbootstrap.com/img/bootstrap-ecommerce/posts/2.webp" height="160" />
								</a>
								<div className="mt-2 text-muted small d-block mb-1">
									<span>
										<i className="fa fa-calendar-alt fa-sm"></i>
						...
						<div className="col-lg-3 col-md-6 col-sm-6 col-12">
							<article>
								<a href="#" className="img-fluid">
									<img className="rounded w-100" src="https://mdbootstrap.com/img/bootstrap-ecommerce/posts/3.webp"  height="160" />
								</a>
								<div className="mt-2 text-muted small d-block mb-1">
									<span>
										<i className="fa fa-calendar-alt fa-sm"></i>
						...
						<div className="col-lg-3 col-md-6 col-sm-6 col-12">
							<article>
								<a href="#" className="img-fluid">
									<img className="rounded w-100" src="https://mdbootstrap.com/img/bootstrap-ecommerce/posts/4.webp"  height="160" />
								</a>
								<div className="mt-2 text-muted small d-block mb-1">
									<span>
										<i className="fa fa-calendar-alt fa-sm"></i>
			...
			</section><footer className="text-center text-lg-start text-muted mt-3" >
				<section className="">
